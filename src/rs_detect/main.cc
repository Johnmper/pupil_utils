    ...
    for(int i = 0; i < device_count; ++i)
    {
        ...
        for(int j = 0; j < RS_STREAM_COUNT; ++j)
        {
            ...
            for(int k = 0; k < mode_count; ++k)
            {
                ...
                std::cout << std::setw(6) << std::right << width << " x ";
                std::cout << std::setw(6) << std::left  << height << " @ ";
                std::cout << std::setw(4) << std::left  << framerate << std::right << " Hz ";
                std::cout << std::setw(12)<< std::left  << format;
                ...
                std::cout << std::setw(6) << std::left << std::setprecision(6) << intrin.hfov() << " x "<<std::left << intrin.vfov() << " degrees, distortion = " << intrin.model() << std::endl;
